/* 3. Com os perfis aleatórios gerados acima, formate-os como um arquivo csv. Dica: um arquivo csv tem seus campos separados por vígula e pode ser representado no seguinte formato:
...
function geraCsv(perfis) {
    for (cadaPerfil of perfis) {// console.log(cadaPerfil)
